...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    if (cvEl) (0, _displayData.displayData)();
    const addBtn = document.getElementById("add");
    if (addBtn) addBtn.addEventListener("click", async (event)=>{
        ...
        if (companyNameInput && jobTitleInput && locationInput && startDateInput && endDateInput && descriptionInput) {
            ...
            try {
                const result = await (0, _addData.addExperienceToDatabase)(companyName, jobTitle, location, startDate, endDate, description);
        ...
        } else console.error("Input elements not found");
    });
});

},{"./displayData":"6enZF","./addData":"3Zind"}],"6enZF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "displayData", ()=>displayData);
var _getData = require("./getData");
var _deleteData = require("./deleteData");
const cvEl = document.getElementById("cv");
async function displayData() {
    const experiences = await (0, _getData.getData)();
    if (!cvEl) {
    ...
    experiences.forEach((item)=>{
        ...
        deleteBtn.addEventListener("click", async ()=>{
            try {
                const success = await (0, _deleteData.deleteExperienceFromDatabase)(item._id);
                if (success) // Ta bort erfarenheten från DOM om raderingen lyckades
...
},{"./getData":"7kMqK","./deleteData":"a8klx","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7kMqK":[function(require,module,exports) {
...
},{}],"a8klx":[function(require,module,exports) {
//Funktion för att radera inlägg
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "deleteExperienceFromDatabase", ()=>deleteExperienceFromDatabase);
async function deleteExperienceFromDatabase(id) {
    try {
        const response = await fetch(`http://localhost:3000/api/workexperiences/${id}`, {
            method: "DELETE"
        });
        console.log(response);
        if (!response.ok) throw new Error("Failed to delete experience from database");
        return true;
    } catch (error) {
        console.error("Failed to delete experience from database:", error);
        return false;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3Zind":[function(require,module,exports) {
//Funktion för att lägga till data i databasen
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addExperienceToDatabase", ()=>addExperienceToDatabase);
const errMessageEl = document.getElementById("errMessage");
async function addExperienceToDatabase(companyname, jobtitle, location, startdate, enddate, description) {
    if (//Kontrollera att ej tomt
    companyname != "" && jobtitle != "" && location != "" && startdate != "" && enddate != "" && description != "") {
        ...
        try {
            ...
            if (!response.ok) throw new Error("Failed to add experience to database");
            const data = await response.json();
            return data;
        } catch (error) {
    ...
    } else errMessageEl.textContent = "Du m\xe5ste fylla i alla f\xe4lt. F\xf6rs\xf6k igen.";
    alert("Ny erfarenhet lades till!");
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["j2YDk","1SICI"], "1SICI", "parcelRequire5b57")
